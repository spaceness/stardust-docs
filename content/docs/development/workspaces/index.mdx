---
title: Workspaces
description: Workspaces are one of the core parts of Stardust. It is the base of a session.
---
...
## VNC server
The VNC server is used to display the desktop of the workspace. Stardust's stock images use [TigerVNC](https://tigervnc.org), as it has the best support for noVNC, which is used in Stardust.
